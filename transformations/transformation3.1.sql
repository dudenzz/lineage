...
-- We use a cursor to simulate the view's join logic and capture lineage from all 3 sources
...
SELECT OrderID, CustomerName, ShipperName, OrderDate, RequiredDate 
FROM Orders o 
INNER JOIN Customers c ON o.CustomerID = c.CustomerID 
INNER JOIN Shippers s ON o.ShipVia = s.ShipperID
